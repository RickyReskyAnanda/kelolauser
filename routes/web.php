...
// Route::get('skpd/berita-acara','SkpdController@viewBeritaAcara')->middleware('ceklogin:skpd');
// Route::get('skpd/input','SkpdController@viewInput');
// Route::post('skpd/input','SkpdController@postInput');
/*BATAS SKPD*/
...
// Route::get('bappeda/kamus-usulan','BappedaController@viewKamusUsulan')->middleware('ceklogin:bappeda');
/*BATAS BAPPEDA*/
