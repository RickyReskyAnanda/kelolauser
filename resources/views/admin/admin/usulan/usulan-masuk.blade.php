            ...
            <div class="col s12">
                ...
                <div class="card">
                    <div class="card-content">
                        <h6>FILTER USULAN</h6>
                        <form class="col s12 formValidate" id="pencarianusulan" method="get" action="{{url('administrator/usulan')}}">
                        ...
                        <div class="row">
                            <div class="col s12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($val->sts_usulan == "DIPROSES BAPPEDA")
                                                <a href="{{url('administrator/usulan/edit/'.$val->id_usul_bappeda)}}" class=" btn cyan white-text" style="width: 100%">Edit</a><br>
                                                <a href="{{url('administrator/usulan/persetujuan/terima/'.$val->id_usul_bappeda)}}" class=" btn green white-text" style="margin-top: 10px;width: 100%">Terima</a><br>
                                                <a href="{{url('administrator/usulan/persetujuan/tolak/'.$val->id_usul_bappeda)}}" class=" btn red white-text" style="margin-top: 10px; width: 100%">Tolak</a>
                                                @endif
                                            </td>
                                        </tr>
                                ...
                                <!-- <ul class="pagination center">
                                    <li class="waves-effect"><a href="#!" class="cyan-text darken-text-1"><i class="mdi-navigation-chevron-left"></i> Halaman 1</a></li>
                                    <li class="waves-effect"><a href="#!" class="cyan-text darken-text-1">Halaman 2 <i class="mdi-navigation-chevron-right"></i></a></li>
                                </ul> -->
                            </div>
                        </div>
                    </div>
