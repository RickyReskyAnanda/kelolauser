                                        ...
                                        <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                            ...
                                            foreach ($data as $val) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('administrator/kamus-usulan/'.$val->id_kegiatan)}}" class="btn waves-effect waves-light blue">Edit</a>
                                                        <a href="{{url('administrator/kamus-usulan/delete/'.$val->id_kegiatan)}}" onclick="confirm('apakah anda ingin menghapus Jalan {{ucfirst($val->nama_pekerjaan)}} ?')" class="btn waves-effect waves-light red darken-4">Hapus</button>
                                                     </td>
                                                </tr>
                                            <?php }
                                             } ?>
