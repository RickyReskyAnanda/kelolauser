    ...
    <div class="section">
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <form class="col s12 formValidate" id="editusulan" method="post" action="{{url('skpd/verifikasi/edit')}}" enctype="multipart/form-data">
                    <div class="card">
                    ...
                    {{csrf_field()}}
                    <input type="hidden" name="id_usul_skpd" value="{{$detail->id_usul_skpd}}">
                    <div class="card">
                        <div class="card-content">
                            <div class="row">
