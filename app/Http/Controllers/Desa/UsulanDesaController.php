...
class UsulanDesaController extends Controller
{
    ...
    public function viewEditUsulan($id){
        ...
        $usulan = KamusUsulanModel::find($detail->id_keg);
    ...
    public function kirimUsulan($id){
        ...
        $kamususulan = KamusUsulanModel::find($desa->id_keg);
        ...
        return redirect('desa/usulan')->with('pesan', 'Usulan telah dikirim ke kecamatan dan tidak dapat dihapus !');
    }
    ...
    public function hapusUsulan($id){
        ...
        if($usulan->sts_usulan!='Proses'){
            return redirect()->back()->with('peringatan', 'Usulan telah dikirim ke kecamatan dan tidak dapat dihapus !');
        }
